    ...
    <div className="mx-auto max-w-4xl px-4 py-10">
      <div className="prose prose-gray max-w-none">
        ...
        <section className="mb-8">
          ...
          <h3 className="mb-3 text-xl font-medium">2.2 Usage Information</h3>
          <p className="mb-4">
          ...
          <p className="mb-4">When you use our services, you may provide:</p>
          <ul className="mb-4 list-disc space-y-2 pl-6">
            <li>Reviews, ratings, and comments about places</li>
        ...
        <section className="mb-8">
          ...
          <ul className="mb-4 list-disc space-y-2 pl-6">
            ...
            <li>
              <strong>Marketing:</strong> To send promotional materials (with
              your consent)
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <h3 className="mb-3 text-xl font-medium">7.1 Types of Cookies</h3>
          <ul className="mb-4 list-disc space-y-2 pl-6">
            <li>
          ...
          <h3 className="mb-3 text-xl font-medium">7.2 Cookie Management</h3>
          <p className="mb-4">
