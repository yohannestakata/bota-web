...
export default function AddReviewEntryPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      <h1 className="font-heading text-4xl font-bold">Add a review</h1>
      <p className="mt-2">Find the place. Share your take. That’s it.</p>
      <input
        type="search"
        value={query}
        onChange={(e) => setQuery(e.target.value)}
        placeholder="Search by name or city..."
        className="border-input bg-background mt-6 mb-4 w-full border p-3 focus:outline-none"
      />
